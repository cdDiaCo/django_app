...
class NecessaryAnswersTests(TestCase):
    ...
    def test_poll_with_few_pages_and_big_score_difference(self):
        ...
        necessary_answers_two = calculate_necessary_answers(poll.id, total_pages, score_difference, answers_received)
    ...
    def test_poll_with_many_pages_and_big_score_difference(self):
        ...
        total_pages = 4
        score_difference = 100
        necessary_answers_one = calculate_necessary_answers(poll.id, total_pages, score_difference, answers_received)
    ...
    def test_poll_with_many_pages_and_small_score_diference(self):
        ...
        total_pages = 4
        score_difference = 20
        necessary_answers_three = calculate_necessary_answers(poll.id, total_pages, score_difference, answers_received)
        score_sum = 30
